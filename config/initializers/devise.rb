...
Devise.setup do |config|
  ...
  # config.secret_key = '72b344c6d566c78e997b1c65d3851fdfa22c63cb9583cc6554c258a02ea000da8f73dd7f644fabcb4b11b248eb9a6c967b929bc4fe72760566fd883ca93f4aed'
  ...
  config.mailer_sender = 'cardswipr@yale.edu'
  ...
  # config.pepper = '77530317f9fe78c916358d12c5b264486cac6cc28053d91b5c5de85f2ab0952a8851fb266a618169b2ce45a9effaa86e36169e5b00c26aab88ea23b2c2127e1b'
  ...
  # ==> CAS
  if Rails.env.test?
    config.cas_base_url = 'https://cas.cas.cas/users/service?ticket=blah'
  else
