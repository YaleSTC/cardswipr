...
ActiveRecord::Schema.define(version: 20140923050053) do

# Could not dump table "attendance_entries" because of following NoMethodError
#   undefined method `column_spec_with_oracle_enhanced' for #<ActiveRecord::ConnectionAdapters::SQLite3Adapter:0x007fa2f3cb6720>
