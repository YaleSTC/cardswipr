...
ActiveRecord::Schema.define(version: 20141012174527) do

# Could not dump table "attendance_entries" because of following NoMethodError
#   undefined method `column_spec_with_oracle_enhanced' for #<ActiveRecord::ConnectionAdapters::SQLite3Adapter:0x007fecd5b6a598>
